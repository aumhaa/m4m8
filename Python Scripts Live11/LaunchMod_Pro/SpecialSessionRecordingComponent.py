...
from ableton.v2.control_surface.components.session_recording import SessionRecordingComponent, track_playing_slot, track_is_recording
...
class SpecialSessionRecordingComponent(SessionRecordingComponent):
    ...
    def __init__(self, target_track_component, *a, **k):
        ...
        super(SpecialSessionRecordingComponent, self).__init__(*a, **k)
