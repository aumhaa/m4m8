...
from ableton.v2.base.util import find_if, first, clamp
...
class ResettableSlideComponent(SlideComponent):
    ...
    def __init__(self, slideable = None, *a, **k):
        ...
        self._position_scroll, self._page_scroll = ResettingScrollComponent(), ResettingScrollComponent()
