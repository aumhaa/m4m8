...
class DefChannelStripComponent(ChannelStripComponent):
	...
	def __init__(self):
		...
		self._default_volume_button_slot = make_button_slot(u'default_volume')
		self._default_panning_button_slot = make_button_slot(u'default_panning')
		self._default_send1_button_slot = make_button_slot(u'default_send1')
		self._default_send2_button_slot = make_button_slot(u'default_send2')
		...
		if not self._default_volume_button is None:
			if liveobj_valid(self._track):
				...
				if self.is_enabled() and self._default_volume_button != None and volume.value == volume.default_value:
					self._default_volume_button.set_light(u'Mixer.DefaultValueOn')
				else:
					self._default_volume_button.set_light(u'Mixer.DefaultValueOff')
			else:
				self._default_volume_button.set_light(u'DefaultButton.Disabled')
		...
		if not self._default_panning_button is None:
			if liveobj_valid(self._track):
				...
				if self.is_enabled() and self._default_panning_button != None and panning.value == panning.default_value:
					self._default_panning_button.set_light(u'Mixer.DefaultValueOn')
				else:
					self._default_panning_button.set_light(u'Mixer.DefaultValueOff')
			else:
				self._default_panning_button.set_light(u'DefaultButton.Disabled')
		...
		if not self._default_send1_button is None:
			if liveobj_valid(self._track):
				...
				if self.is_enabled() and self._default_send1_button != None and sends[0] and sends[0].value == sends[0].default_value:
					self._default_send1_button.set_light(u'Mixer.DefaultValueOn')
				else:
					self._default_send1_button.set_light(u'Mixer.DefaultValueOff')
			else:
				self._default_send1_button.set_light(u'DefaultButton.Disabled')
		...
		if not self._default_send2_button is None:
			if liveobj_valid(self._track):
				...
				if self.is_enabled() and self._default_send2_button != None and sends[1] and sends[1].value == sends[1].default_value:
					self._default_send2_button.set_light(u'Mixer.DefaultValueOn')
				else:
					self._default_send2_button.set_light(u'Mixer.DefaultValueOff')
			else:
				self._default_send2_button.set_light(u'DefaultButton.Disabled')
